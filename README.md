...
A modern web-based chatbot application with a Python FastAPI backend and HTML/JavaScript frontend. Features a clean, responsive UI with real-time AI responses and multilingual support.
